...
import { GenerateRequest, GenerateResponse, TestCase, JiraStoryDetails } from './types'
...
function App() {
  ...
  const [linkedStory, setLinkedStory] = useState<JiraStoryDetails | null>(null)
  ...
  const handleStoryLinked = (details: JiraStoryDetails) => {
    setLinkedStory(details)
  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        {!isJiraConnected ? (
          <JiraConnection onConnectSuccess={handleJiraConnectSuccess} />
        ) : (
          <StorySelector onStoryLinked={handleStoryLinked} />
        )}
